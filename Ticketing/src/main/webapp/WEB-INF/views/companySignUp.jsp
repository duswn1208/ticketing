...
<body data-spy="scroll" data-target=".site-navbar-target"
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav nav ml-auto">
				...
				<li class="nav-item"><a href="<%=cp%>/companyLogin.action"
					class="nav-link"><span>Login</span></a></li>
				<li class="nav-item"><a href="<%=cp%>/companySignUp.action"
	...
	<div class="Layer" align="center">
		...
		<p>
			<a href="<%=cp%>/userSignUp.action" class="btn btn-primary py-2 px-4">일반회원 회원가입</a>
			<a href="<%=cp%>/companySignUp.action" class="btn btn-black py-2 px-4">기업회원 회원가입</a>
		</p>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div style="margin: 0 auto;" align="center">
				...
				<form action="" class="p-5 bg-light" name="companyForm" method="post">
						<div class="form-group" align="left">
							<label style="font-weight: normal;">기업 아이디 *</label> <br /> <input
						...
						<div class="form-group" align="left">
							<label for="name" style="font-weight: normal;">회사명 *</label> <input
						...
						<div class="form-group" align="left">
							<label for="website" style="font-weight: normal;">Company-Tel
								*</label> <input type="text" class="form-control" name="companyTelNum"/>
						</div>

						<div class="form-group">
							<input type="button" value="아이디 생성하기"
								class="btn py-3 px-4 btn-primary" onclick="companySignUp();">
