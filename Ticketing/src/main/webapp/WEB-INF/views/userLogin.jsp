...
<body data-spy="scroll" data-target=".site-navbar-target"
	...
	<%-- <div class="Layer" align="center">
            ...
            <p><a href="<%=cp %>/userLogin.action " class="btn btn-black py-2 px-4" 
            style="background-color: #D81B60;"><font color="white">일반회원 로그인</font></a> 
            <a href="<%=cp %>/companyLogin.action" class="btn btn-secondary py-2 px-4"
            ><font color="white">기업회원 로그인</font></a></p>
          </div> --%>
	<!--   </div>
      </div>
    </section> -->
		...
		<div class="row">
			<div style="margin: 0 auto;" align="center">
				...
				<div class="col-md-6 col-lg-7 px-lg-5 py-md-5 bg-darken" style="width: 1000px;">
					<form action="" class="p-5 bg-darken" name="myForm" method="post">
						<div class="Layer" align="center">
							<h1 class="mb-3 bread">
								<b><font color="#e2c0bb">Login&nbsp;(&nbsp;개인&nbsp;)</font><b />
							</h1>
							<p>
								<a href="<%=cp%>/userLogin.action "
									class="btn btn-primary py-2 px-4"
									><font color="white">일반회원
										로그인</font></a> <a href="<%=cp%>/companyLogin.action"
									class="btn btn-darken py-2 px-4" style="background-color: #232931;"><font
									color="#e2c0bb">기업회원 로그인</font></a>
							</p>
						</div>
						<br />
						<br />
						...
						<div class="form-group" align="left">
							<label for="name" style="font-weight: normal;" class=""><font
								color="#e2c0bb">회원 아이디 *</font></label> <input type="text"
						...
						<div class="form-group" style="width: 500px;" align="left">
							&nbsp;&nbsp; <input type="button" value="로그인"
								class="btn py-3 px-4 btn-primary" onclick="userLogin();"
