...
<body>
	...
	<div style="vertical-align: top; float: left;">
			...
			<table width="200" bgcolor="#363636">
				<tr>
					<td olspan="2" style="border-bottom-width: 1px; border-bottom-style: dotted; border-bottom-color: #000000" ></td>
			...
			<table width="200" bgcolor="#363636">
					...
					<tr>
						...
						<td><font size="4px" st color="#ffffff"><b>40,500</b></font><font size="2px;" color="#ffffff">원</font></td>
					</tr>
			</table>	
			</div>
			<div>
			<table width="200" bgcolor="#363636">
					<tr height="9"><td></td></tr>
					<tr>
						<td><input type="button" style="color:#ffffff;  width: 88px; height: 35px; margin-left: 7px; background-color: #818181; border-color: #818181;" value="이전단계"></td>
						<td><input type="button" id="detail_btn" style="width: 88px; height: 35px;" value="다음단계"></td>
					</tr>
